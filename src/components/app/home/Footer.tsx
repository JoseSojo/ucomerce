...
const Footer: React.FC = () => {
  return (
    <footer id="contacto" className="bg-[#16446A] text-white pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link href="#" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#72AFC1] transition-colors">
                <Facebook size={18} />
              </Link>
              <Link href="#" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#72AFC1] transition-colors">
                <Instagram size={18} />
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin size={18} className="mr-3 mt-1 text-[#72AFC1]" />
                <span className="text-white/80">Av. Reforma 247, Col. Centro, Ciudad de México, CP 06500</span>
              </li>
              <li className="flex items-center">
                <Phone size={18} className="mr-3 text-[#72AFC1]" />
                <Link href="tel:+525555123456" className="text-white/80 hover:text-[#72AFC1] transition-colors">+52 55 5512 3456</Link>
              </li>
              <li className="flex items-center">
                <Mail size={18} className="mr-3 text-[#72AFC1]" />
                <Link href="mailto:info@grupokasama.com" className="text-white/80 hover:text-[#72AFC1] transition-colors">info@grupokasama.com</Link>
              </li>
            </ul>
            <div className="mt-6">
          ...
          <div>
            ...
            <form className="mb-6">
              <div className="flex">
                ...
                <button 
                  type="submit" 
                  className="bg-[#72AFC1] hover:bg-[#5a9daf] px-4 rounded-r-md flex items-center justify-center transition-colors"
                >
                  <Send size={18} />
                </button>
              </div>
        ...
        <div className="container-custom">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 mt-4 md:mt-0">
              <Link href="#" className="text-white/60 text-sm hover:text-[#72AFC1] transition-colors">Términos y Condiciones</Link>
              <Link href="#" className="text-white/60 text-sm hover:text-[#72AFC1] transition-colors">Política de Privacidad</Link>
            </div>
          </div>
        </div>
      </div>
